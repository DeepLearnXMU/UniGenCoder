...
def init_arg_parser():
    ...
    arg_parser.add_argument('--temperature', default=0.5, type = float, help="temperature value")
    arg_parser.add_argument('--con_lambda', default=0.5, type = float, help="contrastive lambda value")
